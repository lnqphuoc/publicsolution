...
public enum ApplyObjectType {
    ...
    */
    ...
    THANH_TOAN_TOAN_BO_CONG_NO_THAM_GIA_TICH_LUY(0, "THANH_TOAN_TOAN_BO_CONG_NO_THAM_GIA_TICH_LUY", "Thanh toán toàn bộ công nợ tham gia chương trình"),
    ...
    ApplyObjectType(int id, String key, String label) {
        this.id = id;
        this.key = key;
        this.label = label;
    }
