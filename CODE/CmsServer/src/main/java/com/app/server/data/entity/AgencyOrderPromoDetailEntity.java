...
@Data
public class AgencyOrderPromoDetailEntity {
    private Integer id;
    ...
    /**
     * hàng tặng được chọn/hàng tặng kèm theo/quà tặng kèm theo
     */
    private int type;
    ...
    public static AgencyOrderPromoDetailEntity from(JSONObject js) {
        AgencyOrderPromoDetailEntity entity = JsonUtils.DeSerialize(
                JsonUtils.Serialize(js), AgencyOrderPromoDetailEntity.class
        );
