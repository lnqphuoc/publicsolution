...
public class EditBannerRequest {
    ...
    private List<Integer> agency_data = new ArrayList<>();
    private List<Integer> city_data = new ArrayList<>();
    private List<Integer> region_data = new ArrayList<>();
    private List<Integer> membership_data = new ArrayList<>();
