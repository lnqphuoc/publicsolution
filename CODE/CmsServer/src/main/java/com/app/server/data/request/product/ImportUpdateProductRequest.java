...
@Getter
@Setter
public class ImportUpdateProductRequest {
    private int id;
    /**
     * mã phiên bản
     */
    ...
    private Integer convert_small_unit_ratio;
...
//        if (code !=StringUtils.isBlank(code)) {
...
//        }
        ...
        if (status != null && ActiveStatus.from(status) == null) {
