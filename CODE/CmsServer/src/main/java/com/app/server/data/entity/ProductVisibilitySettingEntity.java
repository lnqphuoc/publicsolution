...
@Getter
@Setter
public class ProductVisibilitySettingEntity {
    private Integer id;
    private String name;
    ...
    public static ProductVisibilitySettingEntity from(JSONObject js) {
        ProductVisibilitySettingEntity entity = JsonUtils.DeSerialize(
                JsonUtils.Serialize(js), ProductVisibilitySettingEntity.class
        );
