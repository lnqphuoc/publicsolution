...
public class OrderAppointmentService extends BaseService {
    /**
     * Danh sách phiếu hẹn
     *
     * @param request
     * @return
     */
    public ClientResponse filterOrderAppointment(SessionData sessionData, FilterListRequest request) {
        try {
